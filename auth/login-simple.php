                ...
                if (password_verify($password, $user["password"])) {
                    ...
                    if ($user["google2fa_enabled"] == 1) {
                        if (empty($verification_code)) {
                            ...
                            } elseif (class_exists('PragmaRX\Google2FA\Google2FA')) {
                                $google2fa = new \PragmaRX\Google2FA\Google2FA();
                                $valid = $google2fa->verifyKey($user["google2fa_secret"], $verification_code);
                            } else {
                                // Use the simple-2fa.php implementation
                            ...
                            <?php if ($needs_2fa): ?>
                                ...
                                <form method="post" novalidate>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <a href="login-simple.php" class="text-decoration-none">
                            ...
                            <?php else: ?>
                                ...
                                <div class="mt-4 text-center">
                                    <p class="text-muted">
                                        ...
                                        <a href="register.php" class="link-primary fw-medium">Sign up</a>
                                    </p>
                                </div>
                            <?php endif; ?>
                        </div>
