...
<div class="sidebar">
  <div class="sidebar-content">
    ...
    <nav class="mt-4">
      <a href="dashboard.php" class="nav-link" id="dashboardLink"><i class="bi bi-grid-1x2-fill"></i> Dashboard</a>
      <a href="map-db.php" class="nav-link" id="mapLink"><i class="bi bi-map"></i> Map</a>
      <a href="schoolInfo.php" class="nav-link" id="schoolInfoLink"><i class="bi bi-building"></i> School Information</a>
      <a href="teacherAnalysis.php" class="nav-link submenu-link" id="teacherLink"><i class="bi bi-person-workspace"></i> Teacher Analysis</a>
      <a href="schoolLandOwnership.php" class="nav-link" id="ownerLink"><i class="bi bi-people-fill"></i> School Land Ownership</a>
      <a href="crucialResources.php" class="nav-link submenu-link" id="resourcesLink"><i class="bi bi-box-seam"></i> Crucial Resources</a>
      <a href="groupPolicy.php" class="nav-link" id="groupLink"><i class="bi bi-shield-lock-fill"></i> Group Policy</a>
      <a href="auditTrail.php" class="nav-link" id="auditLink"><i class="bi bi-clock-history"></i> Audit Trail</a>
      <a href="register.php" class="nav-link" id="registrationLink"><i class="bi bi-person-plus-fill"></i> Registration</a>
      <a href="#" class="nav-link" id="logoutLink"><i class="bi bi-box-arrow-in-right"></i> Logout</a>
    </nav>
  </div>
</div>
